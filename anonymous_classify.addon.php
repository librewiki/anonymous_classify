<?php
    $first = array("노래하는", "책읽는", "익명의", "구르는", "기여하는", "위키하는", "앉아있는", "날아가는", "놀고있는", "잉여한", "글쓰는", "뛰고있는", "자고있는", "살아있는", "학생", "편집하는", "놀러가는", "수영하는", "게임하는", "손짓하는", "구경하는", "눈팅중인");
    $second = array("리브라", "리디버그", "리브렌", "위키러", "위키니트", "위키냥", "리버티", "리버덕", "리돌이", "륙", "에르빌", "리브레비", "리브리", "리브봇", "프라하", "리브맨", "반달가위", "리브크레", "세피로트", "무냐", "시조새", "드루아", "리브레키", "리브룬", "리브레드", "리프리", "레브", "니브레쿤", "리트랙터", "어그롭스");
